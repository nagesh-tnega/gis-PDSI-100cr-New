<?php
    ...
    function editData() {
		...
		// $update_query = "UPDATE sp_index_v2 set project_id = '$prj_id', name_of_the_project= '$prj_name', implementing_agency= '$implementing_agency', funding_agency = '$fund_agency', government_orders = '$gov_orders', short_description_of_the_project = '$prj_desc', project_start_date = '$start_date', project_end_date = '$end_date', project_cost = '$prj_cost', fund_received = '$fund_recieved', fund_yet_to_be_received = '$fund_yet_to_received', district_name = '$prj_dist', taluk_name = '$taluk', village_name = '$village', survey_no = '$survey_no', latitude = '$lat', longitude = '$lon' , total_project_extend = '$total_project_extend', work_completed_details_with_extend = '$work_completed', work_in_progress_details_with_extend = '$work_in_progress', work_to_be_completed_details_with_extend = '$work_to_be_completed', remarks = '$remarks', layers = '$layers', eot = '$edi_extend_date', updated_time = current_timestamp, revised_start_date = '$revised_start_date', revised_end_date = '$revised_end_date', present_status = '$present_status', causes_of_delay = '$causes_of_delay', other_reasons_delay = '$causes_of_other_delay', cost_overrun = '$cost_overrun', cost_overrun_reasons = '$cost_overrun_reasons' where id = $id" ;
		if(is_null($created_time)) {
			$update_query = "UPDATE sp_index_v2 set project_id = '$prj_id', name_of_the_project= '$prj_name', implementing_agency= '$implementing_agency', funding_agency = '$fund_agency', government_orders = '$gov_orders', short_description_of_the_project = '$prj_desc', project_start_date = '$start_date', project_end_date = '$end_date', project_cost = '$prj_cost', fund_received = '$fund_recieved', fund_yet_to_be_received = '$fund_yet_to_received', district_name = '$prj_dist', taluk_name = '$taluk', village_name = '$village', survey_no = '$survey_no', latitude = '$lat', longitude = '$lon' , total_project_extend = '$total_project_extend', work_completed_details_with_extend = '$work_completed', work_in_progress_details_with_extend = '$work_in_progress', work_to_be_completed_details_with_extend = '$work_to_be_completed', remarks = '$remarks', layers = '$layers', created_time = current_timestamp ,eot = '$edi_extend_date', updated_time = current_timestamp, revised_start_date = '$revised_start_date', revised_end_date = '$revised_end_date', present_status = '$present_status', causes_of_delay = '$causes_of_delay', other_reasons_delay = '$causes_of_other_delay', cost_overrun = '$cost_overrun', cost_overrun_reasons = '$cost_overrun_reasons' where id = $id" ;
		}
		else {
	...
	function getReport() {
		 ...
		 $result = pg_query(DBCON, "select a.dept_name,a.dept_code, a.hod_name,a.hod_dept_code, b.name_of_the_project, b.funding_agency, b.short_description_of_the_project, b.project_start_date, b.project_end_date, b.project_cost, b.fund_received, b.fund_yet_to_be_received,b.remarks,b.eot, b.id,b.layers, b.latitude, b.longitude, b.causes_of_delay,b.cost_overrun_reasons,b.cost_overrun,DATE(b.updated_time) as updated_date,b.district_name,b.taluk_name,b.village_name from masters.dept_users as a , sp_index_v1 as b where a.hod_dept_code = b.hod_name and a.dept_name != '' order by a.dept_name asc");
  ...
  function getGeomCol($table) {
	...
	function getProjectNameByImplAgency(){
		if(isset($_GET['hId'])){
			$hod_code = $_GET['hId'];
			$query = "select project_id,name_of_the_project as project_name from sp_index_v1 where hod_name='$hod_code' and created_time is not null ";
			$result = pg_query(DBCON, $query);
			$rs = pg_fetch_all($result);
			return $rs;
